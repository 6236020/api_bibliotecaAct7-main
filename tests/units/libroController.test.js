...
describe("Libro Controller", () => {
    ...
    test("get LibroById debería obtener un libro", async () => {
    ...
    test("create Libro debería crear un nuevo libro", async () => {
    ...
    test("update Libro debería actualizar un libro existente", async () => {
        const libroId = '1';
    ...
    test("update Libro debería devolver un error si el libro no existe", async () => {
    ...
    test("delete Libro debería eliminar un libro existente", async () => {
